...
# Amphibia
# spaceCor
gls.amp.1.exp <- gls(fdis_amp ~ climate_amp + Elevation + Productivity + dr_amp + aa_amp, data=sem_dataset, correlation = spaceExp)
...
#spaceGaus
gls.amp.1.gaus <- gls(fdis_amp ~ climate_amp + Elevation + Productivity + dr_amp + aa_amp, data=sem_dataset, correlation = spaceGaus)
...
#spaceLin
#gls.amp.1.lin <- gls(fdis_amp ~ climate_amp + Elevation + Productivity + dr_amp + aa_amp, data=sem_dataset, correlation = spaceLin)
...
#spaceRatio
gls.amp.1.ratio <- gls(fdis_amp ~ climate_amp + Elevation + Productivity + dr_amp + aa_amp, data=sem_dataset, correlation = spaceRatio)
...
#spaceSpher
gls.amp.1.spher <- gls(fdis_amp ~ climate_amp + Elevation + Productivity + dr_amp + aa_amp, data=sem_dataset, correlation = spaceSpher)
...
```{r}
# spaceExp
gls.rep.1.exp <- gls(fdis_squa ~ climate_squa + Elevation + Productivity + dr_squa + aa_squa, data=sem_dataset, correlation= corExp(c(500, 0.1), form =~ V2+V1, nugget=T))
gls.rep.2.exp <- gls(rich_squa ~ climate_squa + Elevation + Productivity + dr_squa + aa_squa, data=sem_dataset, correlation = corExp(c(500, 0.1), form =~ V2+V1, nugget=T))
...
# spaceGaus
gls.rep.1.gaus <- gls(fdis_squa ~ climate_squa + Elevation + Productivity + dr_squa + aa_squa, data=sem_dataset, correlation = spaceGaus)
...
# spaceLin
gls.rep.1.lin <- gls(fdis_squa ~ climate_squa + Elevation + Productivity + dr_squa + aa_squa, data=sem_dataset, correlation=spaceLin)
...
# spaceRatio
gls.rep.1.ratio <- gls(fdis_squa ~ climate_squa + Elevation + Productivity + dr_squa + aa_squa, data=sem_dataset, correlation=spaceRatio)
...
# spaceSpher
gls.rep.1.spher <- gls(fdis_squa ~ climate_squa + Elevation + Productivity + dr_squa + aa_squa, data=sem_dataset, correlation=spaceSpher)
...
```{r}
# spaceExp
gls.bird.1.exp <- gls(fdis_birds ~ climate_birds + Elevation + Productivity + dr_birds + aa_birds,data=sem_dataset,  correlation = corExp(c(200, 0.1), form =~ V2+V1, nugget=T))
...
gls.bird.4.exp <- gls(dr_birds ~ aa_birds + climate_birds + Elevation + Productivity, data = sem_dataset, correlation = corExp(c(800, 0.1), form =~ V2+V1, nugget=T))
...
# spaceLin
gls.bird.1.lin <- gls(fdis_birds ~ climate_birds + Elevation + Productivity + dr_birds + aa_birds,data=sem_dataset, correlation = corLin(c(200, 0.1), form =~ V2+V1, nugget=T))
...
gls.bird.4.lin <- gls(dr_birds ~ aa_birds + climate_birds + Elevation + Productivity, data = sem_dataset, correlation = corLin(c(500, 0.1), form =~ V2+V1, nugget=T))

# spaceRatio
gls.bird.1.ratio <- gls(fdis_birds ~ climate_birds + Elevation + Productivity + dr_birds + aa_birds,data=sem_dataset, correlation = spaceRatio)
...
# spaceSpher
gls.bird.1.spher <- gls(fdis_birds ~ climate_birds + Elevation + Productivity + dr_birds + aa_birds,data=sem_dataset, correlation = spaceSpher)
...
```{r}
# spaceExp
gls.mam.1.exp <- gls(fdis_mammals ~ climate_mammals + Elevation + Productivity + dr_mammals + aa_mammals,data=sem_dataset, correlation = spaceExp)
...
# spaceGaus
gls.mam.1.gaus <- gls(fdis_mammals ~ climate_mammals + Elevation + Productivity + dr_mammals + aa_mammals,data=sem_dataset, correlation=spaceGaus)
...
# spaceLin
gls.mam.1.lin <- gls(fdis_mammals ~ climate_mammals + Elevation + Productivity + dr_mammals + aa_mammals,data=sem_dataset, correlation=corLin(c(200, 0.1), form =~ V2+V1, nugget=T))
...
# spaceRatio
gls.mam.1.ratio <- gls(fdis_mammals ~ climate_mammals + Elevation + Productivity + dr_mammals + aa_mammals,data=sem_dataset, correlation=spaceRatio)
...
# spaceSpher
gls.mam.1.spher <- gls(fdis_mammals ~ climate_mammals + Elevation + Productivity + dr_mammals + aa_mammals,data=sem_dataset, correlation=spaceSpher)
...
gls.mam.4.spher <- gls(dr_mammals ~ aa_mammals + climate_mammals + Elevation + Productivity, data = sem_dataset, correlation = corSpher(c(200, 0.1), form =~ V2+V1, nugget=T))
```
...
```{r}
# Anfíbios
AIC(gls.amp.1.exp, gls.amp.1.gaus, gls.amp.1.ratio, gls.amp.1.spher) #gls.amp.1.spher
...
AIC(gls.amp.4.exp, gls.amp.4.gaus, gls.amp.4.ratio, gls.amp.4.spher, gls.amp.4.lin) # gls.amp.4.exp  

#diagnosis
amp1 <- plot(gls.amp.1.spher, main="gls.amp.1.spher")
amp2 <- plot(gls.amp.2.ratio, main="gls.amp.2.ratio")
amp3 <- plot(gls.amp.3.exp, main="gls.amp.3.exp")
amp4 <- plot(gls.amp.4.exp, main="gls.amp.4.exp")
#plot
...
###### 2.3.2. Squamata
```{r}
AIC(gls.rep.1.exp, gls.rep.1.gaus, gls.rep.1.lin, gls.rep.1.ratio, gls.rep.1.spher) # gls.rep.1.lin
AIC(gls.rep.2.exp, gls.rep.2.ratio, gls.rep.2.gaus, gls.rep.2.lin, gls.rep.2.spher) # gls.rep.2.ratio
...
rep1 <- plot(gls.rep.1.lin, main="gls.rep.1.lin")
...
###### 2.3.3. Birds
```{r}
AIC(gls.bird.1.gaus, gls.bird.1.lin, gls.bird.1.ratio, gls.bird.1.spher, gls.bird.1.exp)  #gls.bird.1.spher 
AIC(gls.bird.2.exp, gls.bird.2.gaus, gls.bird.2.ratio, gls.bird.2.spher) #gls.bird.2.ratio
AIC(gls.bird.3.exp, gls.bird.3.gaus, gls.bird.3.ratio, gls.bird.3.spher, gls.bird.3.lin) #gls.bird.3.lin 
AIC(gls.bird.4.exp,gls.bird.4.gaus, gls.bird.4.lin, gls.bird.4.ratio, gls.bird.4.spher) # gls.bird.4.ratio 

# squamata gls diagnosis
bird1 <- plot(gls.bird.1.spher, main="gls.bird.1.spher")
bird2 <- plot(gls.bird.2.ratio, main="gls.bird.2.ratio")
bird3 <- plot(gls.bird.3.lin, main="gls.bird.3.lin")
...
mam3 <- plot(gls.mam.3.spher, main="gls.mam.3.spher")
...
```{r}
# amphibia
anura.psem <- psem(gls.amp.1.spher, gls.amp.2.ratio, gls.amp.3.exp, gls.amp.4.exp)
summary(anura.psem)
resid.anura <- residuals(anura.psem)

#Squamata
reptilia.psem <- psem(gls.rep.1.lin, gls.rep.2.ratio, gls.rep.3.ratio, gls.rep.4.spher)
#summary(reptilia.psem)
resid.rep <- residuals(reptilia.psem)

#Birds
birds.psem <- psem(gls.bird.1.spher, gls.bird.2.lin, gls.bird.3.lin, gls.bird.4.ratio)
#summary(birds.psem)
resid.birds <- residuals(birds.psem)

#Mammals
mammals.psem <- psem(gls.mam.1.spher, gls.mam.2.spher, gls.mam.3.spher, gls.mam.4.exp)
