...
# dataset elevation, aggregation median, sources gmted2010, resolution 1km
...
data_abiotic_all <- cbind(data_abiotic, data_topography)
...
# amphibia
write.tree(phy_amphibia_all, "02_metrics/nonharmonized_data/amphibia.tre") # 487 spp
write.table(amphibia_list, "02_metrics/nonharmonized_data/list_amphibia.txt") #519 spp - +id
write.table(amphibia_traits_na, "02_metrics/nonharmonized_data/trait_amphibia.txt")# 506 spp

# squamata
write.tree(full_squamata_phy, "02_metrics/nonharmonized_data/squamata.tre") # 382 spp
write.table(squamata_full_list, "02_metrics/nonharmonized_data/list_squamata.txt") #403 spp - +id
write.table(squamata_traits_na, "02_metrics/nonharmonized_data/trait_squamata.txt")# 380 spp

# birds
write.tree(full_birds_phy, "02_metrics/nonharmonized_data/birds.tre") # 695 spp
write.table(birds_full_list, "02_metrics/nonharmonized_data/list_birds.txt") #815 spp - +id
write.table(birds_traits_na, "02_metrics/nonharmonized_data/trait_birds.txt")# 777 spp

# mammals
write.tree(full_mammals_phy, "02_metrics/nonharmonized_data/mammals.tre") # 196 spp
write.table(mammals_full_list, "02_metrics/nonharmonized_data/list_mammals.txt") #236 spp - +id
write.table(mammals_traits_na, "02_metrics/nonharmonized_data/trait_mammals.txt") # 232 spp
#---------------------
```
