...
tree_birds <- read.tree("phylogeny/phy_birds.tre")
...
birds_phy <- prune.sample(birds_list, tree_birds) # 695 spp.

match.phylo.comm(tree_birds, birds_list)
