...
###### 2.1.1. Richness
```{r}
richness_amphibia <- as.data.frame(cbind(full = full_rich_amphibia$richness, harm = harm_rich_amphibia$richness))
richness_squamata <- as.data.frame(cbind(full = full_rich_squamata$richness, harm = harm_rich_squamata$richness))
richness_birds <- as.data.frame(cbind(full = full_rich_birds$richness, harm = harm_rich_birds$richness))
richness_mammals <- as.data.frame(cbind(full = full_rich_mammals$richness, harm = harm_rich_mammals$richness))

amphibia_rich <- ggscatter(richness_amphibia, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Amphibia")

squamata_rich <- ggscatter(richness_squamata, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Squamata")

birds_rich <- ggscatter(richness_birds, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Birds")

mammals_rich <- ggscatter(richness_mammals, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Mammals")
...
```{r}
dr_amphibia <- as.data.frame(cbind(full = full_amphibia_dr, harm = harm_amphibia_dr))
colnames(dr_amphibia) <- c('full', 'harm')

dr_squamata <- as.data.frame(cbind(full = full_squamata_dr, harm = harm_squamata_dr))
colnames(dr_squamata) <- c('full', 'harm')

dr_birds <- as.data.frame(cbind(full = full_birds_dr, harm = harm_birds_dr))
colnames(dr_birds) <- c('full', 'harm')

dr_mammals <- as.data.frame(cbind(full = full_mammals_dr, harm = harm_mammals_dr))
colnames(dr_mammals) <- c('full', 'harm')

amphibia_dr <- ggscatter(dr_amphibia, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Amphibia")

squamata_dr <- ggscatter(dr_squamata, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Squamata")

birds_dr <- ggscatter(dr_birds, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Birds")

mammals_dr <- ggscatter(dr_mammals, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Mammals")
...
```{r}
aa_amphibia <- as.data.frame(cbind(full = full_aa_amphibia$mean_age_arrival, harm = harm_aa_amphibia$mean_age_arrival))
aa_squamata <- as.data.frame(cbind(full = full_aa_squamata$mean_age_arrival, harm = harm_aa_squamata$mean_age_arrival))
aa_birds <- as.data.frame(cbind(full = full_aa_birds$mean_age_arrival, harm = harm_aa_birds$mean_age_arrival))
aa_mammals <- as.data.frame(cbind(full = full_aa_mammals$mean_age_arrival, harm = harm_aa_mammals$mean_age_arrival))

amphibia_aa <- ggscatter(aa_amphibia, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Amphibia")

squamata_aa <- ggscatter(aa_squamata, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Squamata")

birds_aa <- ggscatter(aa_birds, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Birds")

mammals_aa <- ggscatter(aa_mammals, x = "full", y = "harm", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Full dataset", ylab = "Harmonized dataset",
          main="Mammals")
...
##### 3.0. Composite variable climate

##### 4.0. Save new datasets for Structural Equation Model (SEM)
