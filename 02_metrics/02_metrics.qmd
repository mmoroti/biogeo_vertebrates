...
```{r}
amphibia_data <- as.data.frame(cbind(id=richness_amphibia$id,rich_amp=richness_amphibia$harm_rich,dr_amp= dr_amphibia$harm_dr, aa_amp = aa_amphibia$full_aa, fdis_amp = FDis_metric_amphibia$FDis))

squamata_data <- as.data.frame (cbind(id=richness_squamata$id,rich_squa=richness_squamata$harm_rich,dr_squa= dr_squamata$harm_dr, aa_squa = aa_squamata$full_aa, fdis_squa = FDis_metric_reptiles$FDis))

birds_data <- as.data.frame(cbind(id=richness_birds$id,rich_birds=richness_birds$harm_rich,dr_birds= dr_birds$harm_dr, aa_birds = aa_birds$full_aa, fdis_birds = FDis_metric_birds$FDis))

mammals_data <- as.data.frame(cbind(id=richness_mammals$id,rich_mammals=richness_mammals$harm_rich,dr_mammals= dr_mammals$harm_dr, aa_mammals = aa_mammals$full_aa, fdis_mammals = FDis_metric_mammals$FDis))
